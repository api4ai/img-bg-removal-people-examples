...
let OPTIONS = [
    ...
    "normal": [
        "url": "https://api4ai.cloud/img-bg-removal/v1/people/results?mode=\(RESULT_MODE)",
...
let image = CommandLine.arguments.count > 1 ? CommandLine.arguments[1] : "https://static.api4.ai/samples/img-bg-removal-people-2.jpg"
var httpBody: Data;
if (image.contains("://")) {
    // POST image via URL.
