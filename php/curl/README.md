# API4AI people background removal sample

This directory contains a minimalistic sample that sends requests to the API4AI People Background Removal API.
...
Use [RapidAPI marketplace](https://rapidapi.com/api4ai-api4ai-default/api/people-background-removal/details) to get the API key. The marketplace offers both
...
* 🔵 Our API at RapidAPI marketplace: https://rapidapi.com/api4ai-api4ai-default/api/people-background-removal/details
