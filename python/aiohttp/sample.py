...
OPTIONS = {
    'demo': {
        'url': f'https://demo.api4ai.cloud/img-bg-removal/v1/people/results?mode={RESULT_MODE}'
    },
    'normal': {
        'url': f'https://api4ai.cloud/img-bg-removal/v1/people/results?mode={RESULT_MODE}',
        'headers': {'X-API-KEY': API4AI_KEY}
    },
    'rapidapi': {
        'url': f'https://people-photo-background-removal.p.rapidapi.com/v1/results?mode={RESULT_MODE}',
...
async def main():
    """Entry point."""
    image = sys.argv[1] if len(sys.argv) > 1 else 'https://static.api4.ai/samples/img-bg-removal-people-2.jpg'
